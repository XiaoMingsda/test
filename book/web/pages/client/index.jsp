    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("button.addToCart").click(function () {
                ...
                //发ajax请求，添加商品到购物车
                $.getJSON("${pageContext.getAttribute("basePath")}cartServlet","action=ajaxAddItem&id=" + bookId, function (data) {
                    //console.log(data);
                    //{lastName: "木虚肉盖饭", totalCount: 2}
...
<div id="header">
    ...
    <div>
        ...
        <%--   如果已经登录，则显示   登录 成功之后的信息        --%>
        <c:if test="${not empty sessionScope.user}">
            <span>欢迎<span class="um_span">${sessionScope.user.username}</span>光临尚硅谷书城</span>
            <a href="pages/order/order.jsp">我的订单</a>
            <a href="/book/userServlet?action=logout">注销</a>&nbsp;&nbsp;
        </c:if>
