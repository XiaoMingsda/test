...
public class LoginUI {
    ...
    private static void showCustomDialog(Frame owner, Component parentComponent) {
        ...
        JPanel panel = new JPanel();
        JPanel panel1 = new JPanel();//第一个JPanel
        panel1.setBorder(new LineBorder(Color.CYAN));
        panel1.setBounds(10, 10, 364, 98);
        panel1.add(new Label("first"));//将标签放入面板中
        panel.add(panel1);//将panel放入jframe界面
